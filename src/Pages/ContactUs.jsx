          ...
          <div className="my-8">
            <div className="md:flex justify-center space-y-2 md:space-y-0 items-center gap-4 mt-4">
              <ContactDiv
                icon={<LuPhoneCall />}
                heading="PHONE"
                desc1="+880 1888-677322"
              />
              <ContactDiv
                icon={<SlLocationPin />}
                heading="ADDRESS"
                desc1="Sector-3, Uttara, Dhaka"
              />
              <ContactDiv
                icon={<BsStopwatch />}
              ...
              <div className=" rounded-lg p-2 md:px-20 md:pt-20 md:pb-12 bg-[#F3F3F3]">
                <form ref={form} onSubmit={sendEmail} className="md:grid grid-cols-2 gap-3  font-inter">
                  ...
                  <div className="flex justify-center col-span-2 mt-3 md:mt-10">
                    <div className="flex justify-center gap-1 p-3 rounded-lg items-center bg-gradient-to-r from-[#00938a] to-[#194744]">
                      <input
                        type="submit"
                        value="Send Message"
